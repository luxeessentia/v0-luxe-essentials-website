    ...
    <div className="flex min-h-screen bg-[#faf7f5]">
      ...
      <main className="flex-1 pb-16">
        ...
        <section className="mt-16 px-4 md:px-8">
          <h2 className="text-2xl font-light text-[#8a5a5e] mb-6">Handmade Bags</h2>
        ...
        <section className="mt-16 px-4 md:px-8">
          <h2 className="text-2xl font-light text-[#8a5a5e] mb-6">Beauty/Makeup</h2>
          <ProductCarousel category="beauty" />
        </section>

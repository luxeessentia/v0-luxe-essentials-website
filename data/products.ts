...
export const products: Product[] = [
  // Tech & Accessories Category
  {
    ...
    price: "$24.99",
    image: "/images/products/digital-watch-blue.jpg",
    additionalImages: ["/images/products/digital-watch-display.jpg"],
    description:
  ...
  },
  {
    ...
    price: "$19.99",
    image: "/images/products/mint-power-bank.jpg",
    additionalImages: ["/images/products/power-bank-in-use.jpg"],
    description:
  ...
  },
  {
    ...
    additionalImages: ["/images/products/waterproof-speaker.jpg"],
    description:
  ...
  // Jewelry Category
  {
    ...
    price: "$14.94",
    image: "/images/products/layered-necklace-turquoise.jpg",
    description:
  ...
  },
  {
    ...
    price: "$29.99",
    image: "/images/products/opal-ring-set.jpg",
    description:
  ...
  },
  {
    ...
    price: "$24.99",
    image: "/images/products/gold-pink-jewelry-set.jpg",
    description:
  ...
  // Bags Category
  {
    ...
    price: "$19.99",
    image: "/images/products/fuzzy-clutch-bags.jpg",
    description:
